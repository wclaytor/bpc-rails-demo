...
image_path = "authors/robert_c_martin/robert_c_martin.jpg"
author = Author.create(name: "Robert C. Martin", bio:, image_path:)
...
image_path = "authors/robert_c_martin/clean_code.jpg"
Book.create(title: "Clean Code: A Handbook of Agile Software Craftsmanship", author:, publication_year: 2008, summary:, image_path:)
...
image_path = "authors/robert_c_martin/clean_coder.jpg"
Book.create(title: "The Clean Coder: A Code of Conduct for Professional Programmers", author:, publication_year: 2008, summary:, image_path:)
...
image_path = "authors/martin_fowler/martin_fowler.jpg"
author = Author.create(name: "Martin Fowler", bio:, image_path:)
...
image_path = "authors/martin_fowler/refactoring.jpg"
Book.create(title: "Refactoring: Improving the Design of Existing Code", author:, publication_year: 2018, summary:, image_path:)
...
image_path = "authors/kent_beck/kent_beck.jpg"
author = Author.create(name: "Kent Beck", bio:, image_path:)
...
image_path = "authors/kent_beck/tdd.jpg"
Book.create(title: "Test Driven Development: By Example", author:, publication_year: 2021, summary:, image_path:)
...
image_path = "authors/gayle_laakmann_mcdowell/gayle_laakmann_mcdowell.jpg"
author = Author.create(name: "Gayle Laakmann McDowell", bio:, image_path:)
...
image_path = "authors/gayle_laakmann_mcdowell/cracking.jpg"
Book.create(title: "Cracking the Coding Interview: 189 Programming Questions and Solutions", author:, publication_year: 2015, summary:, image_path:)
...
image_path = "authors/david_farley/david_farley.jpg"
author = Author.create(name: "David Farley", bio:, image_path:)
...
image_path = "authors/david_farley/modern.jpg"
Book.create(title: "Modern Software Engineering: Doing What Works to Build Better Software Faster", author:, publication_year: 2021, summary:, image_path:)
...
image_path = "authors/esther_derby/esther_derby.jpg"
author = Author.create(name: "Esther Derby, Diana Larsen", bio:, image_path:)
...
image_path = "authors/esther_derby/agile.jpg"
Book.create(title: "Agile Retrospectives: Making Good Teams Great", author:, publication_year: 2021, summary:, image_path:)
...
image_path = "authors/gang_of_four/gang_of_four.webp"
author = Author.create(name: "Gang of Four", bio:, image_path:)
...
image_path = "authors/gang_of_four/design_patterns.jpg"
Book.create(title: "Design Patterns: Elements of Reusable Object-Oriented Software", author:, publication_year: 1994, summary:, image_path:)
...
image_path = "authors/russ_olsen/russ_olsen.jpg"
author = Author.create(name: "Russ Olsen", bio:, image_path:)
...
image_path = "authors/russ_olsen/eloquent_ruby.jpg"
Book.create(title: "Eloquent Ruby", author:, publication_year: 2011, summary:, image_path:)
...
image_path = "authors/sandi_metz/sandi_metz.jpg"
author = Author.create(name: "Sandi Metz", bio:, image_path:)
...
image_path = "authors/sandi_metz/practical.jpg"
Book.create(title: "Practical Object-Oriented Design: An Agile Primer Using Ruby", author:, publication_year: 2018, summary:, image_path:)
